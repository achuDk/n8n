...
export class GitConnectionsPublicController {
	...
	async getGitConnectionProjects(
		...
		return await this.gitConnections.listProjects(id);
	}
	...
	async assignProjectToGitConnection(
		...
		return await this.gitConnections.assignProject(id, projectId);
	}
	...
	async unlinkProjectFromGitConnection(
		...
		await this.gitConnections.unlinkProject(id, projectId);
	}
}
